...
$marr['SHOP_ID'] = "Вписать сюда/Write here"; 	// ID магазина с которого нужно сделать выплату / Shop ID from which need to make payment
$marr['API_ID'] = "Вписать сюда/Write here"; 	// API ID / API ID
$marr['API_PASS'] = "Вписать сюда/Write here"; 	// API пароль / API password