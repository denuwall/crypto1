...
class AP_BlockIo
{
    ...
    public function __construct($api_key, $pin, $api_version = 2, $ssl='')
    { // the constructor
      $this->api_key = $api_key;
      $this->pin = $pin;
      $this->version = $api_version;
	  $this->ssl_mode = intval($ssl);
