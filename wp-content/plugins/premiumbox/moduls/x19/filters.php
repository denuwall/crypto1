...
add_action('pn_direction_edit_before','pn_direction_edit_x19'); 
add_action('pn_direction_add','pn_direction_edit_x19');
function pn_direction_edit_x19($data_id){
				...
				if($x19mod == 20){
					...
					try{
						...
						if(is_object($object)){
							...
							$retval = 1000;
							$aResponse['retdesc'] = __('X19 interface error','pn');
						}
					} catch(Exception $e){
