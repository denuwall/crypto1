        ...
        <tr>
			...
			<div class="premium_wrap_standart">
				...
				$array = array(
					...
					'txt_give' => __('Field title "From Account"','pn'),
					'txt_get' => __('Field title "Onto Account"','pn'),
									...
									if(count($bd_array) > 0){
										...
										if($data_id){
											...
											if(isset($vd->id)){
												...
												if(isset($bd_array['txt_give'])){
													$bd_array['txt_give'] = replace_value_ml($vd->txt_give, $bd_array['txt_give'], $locale);
												}
												if(isset($bd_array['txt_get'])){
													$bd_array['txt_get'] = replace_value_ml($vd->txt_get, $bd_array['txt_get'], $locale);
												}													
										...
										if($install == 1){
											if(isset($bd_array['psys_title']) and isset($bd_array['currency_code_title'])){
