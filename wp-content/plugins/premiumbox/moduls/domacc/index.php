...
global $wpdb;	
	...
	if($domacc == 1){
		$where .= " AND {$wpdb->prefix}exchange_bids.domacc1 = '1'";
	} elseif($domacc == 2){
		$where .= " AND {$wpdb->prefix}exchange_bids.domacc2 = '1'";
	} elseif($domacc == 3){
		$where .= " AND {$wpdb->prefix}exchange_bids.domacc1 = '0' AND {$wpdb->prefix}exchange_bids.domacc2 = '0'";
	}
