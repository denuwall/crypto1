...
add_action('pn_moduls_active_'.$name, 'bd_pn_moduls_active_operator');
function bd_pn_moduls_active_operator(){
global $wpdb;
...
global $premiumbox;
	...
	$hook = add_submenu_page( "pn_operator", __('Operator schedule','pn'), __('Operator schedule','pn'), 'administrator', "pn_schedule_operators", array($premiumbox, 'admin_temp'));
