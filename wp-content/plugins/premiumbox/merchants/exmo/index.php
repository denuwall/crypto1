		...
		function get_merchant_admin_options($options, $data){
  		...
  		function merchant_bidaction($temp, $pay_sum, $item, $direction){
			...
			<div class="zone center"> 
				...
				<p>'. __('In order to pay an ID order','pn') .' <b>'. $item->id.'</b>,<br /> '. __('enter coupon code valued','pn').' <b><span class="clpb_item" data-clipboard-text="'. $pay_sum .'">'. $pay_sum . '</span> ExMo '. is_site_value($item->currency_code_give).'</b>:</p>
