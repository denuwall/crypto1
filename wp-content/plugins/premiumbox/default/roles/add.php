...
add_action('pn_adminpage_title_pn_add_roles', 'pn_admin_title_pn_add_roles');
function pn_admin_title_pn_add_roles(){
...
add_action('pn_adminpage_content_pn_add_roles','def_pn_admin_content_pn_add_roles');
function def_pn_admin_content_pn_add_roles(){
global $wpdb;
	...
	if($data_id){
		$back_menu['add'] = array(
			'link' => admin_url('admin.php?page=pn_add_roles'),
			'title' => __('Add new','pn')
		);	
	}
...
add_action('premium_action_pn_add_roles','def_premium_action_pn_add_roles');
function def_premium_action_pn_add_roles(){
global $wpdb;	
	...
	$url = admin_url('admin.php?page=pn_add_roles&item_key='. $data_key .'&reply=true');
